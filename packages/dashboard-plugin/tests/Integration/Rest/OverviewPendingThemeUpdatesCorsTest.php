 ...
 * @group integration
 *
 * Regression coverage for the P2.8 GET /defyn/v1/overview/pending-theme-updates
 ...
 *
 * Mirrors the P2.7 OverviewPendingPluginUpdatesCorsTest pattern: drive the
...
final class OverviewPendingThemeUpdatesCorsTest extends AbstractSchemaTestCase
{
    ...
    public function testOptionsPreflightOnPendingThemeUpdatesRouteReturnsCorsHeaders(): void
    {
        ...
        self::assertSame(
            ...
            'OPTIONS preflight must advertise GET so the SPA can preflight the pending-theme-updates fetch',
        );
