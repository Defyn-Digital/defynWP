...
/**
 * P5.2 — CORS regression for the branded-PDF route:
 *   - GET /defyn/v1/sites/{id}/report.pdf
 *
 ...
 * @group integration
 */
final class SitesReportPdfCorsTest extends AbstractSchemaTestCase
{
    ...
    {
        return [
            'GET /sites/1/report.pdf' => ['GET', '/defyn/v1/sites/1/report.pdf'],
        ];
    }
}
