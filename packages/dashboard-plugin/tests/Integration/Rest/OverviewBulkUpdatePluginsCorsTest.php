 ...
 * @group integration
 *
 * Regression coverage for the P2.7 POST /defyn/v1/overview/bulk-update-plugins
...
final class OverviewBulkUpdatePluginsCorsTest extends AbstractSchemaTestCase
{
    ...
    public function testOptionsPreflightOnBulkUpdatePluginsRouteReturnsCorsHeaders(): void
    {
        ...
        self::assertSame(
            ...
            'OPTIONS preflight must advertise POST so the SPA can preflight the bulk-update-plugins fan-out',
        );
