...
/**
 * P6.1 Task 12 — CORS + route-resolution regression for the performance routes:
 *   - GET  /defyn/v1/sites/{id}/performance
 *   - POST /defyn/v1/sites/{id}/performance/scan
 *
 * Mirrors ReportsCorsTest: drives Cors::apply directly because
 ...
 * /performance/scan doesn't collide with /performance.
 *
 * @group integration
 */
final class PerformanceCorsTest extends AbstractSchemaTestCase
{
    ...
    {
        return [
            'GET /sites/1/performance'       => ['GET', '/defyn/v1/sites/1/performance'],
            'POST /sites/1/performance/scan' => ['POST', '/defyn/v1/sites/1/performance/scan'],
        ];
    }
    ...
    // routes actually registered (and that POST /performance/scan doesn't
    // collide with GET /performance).
    // -------------------------------------------------------------------------
    ...
    {
        return [
            'GET /sites/999999/performance'       => ['GET', '/defyn/v1/sites/999999/performance'],
            'POST /sites/999999/performance/scan' => ['POST', '/defyn/v1/sites/999999/performance/scan'],
        ];
    }
}
