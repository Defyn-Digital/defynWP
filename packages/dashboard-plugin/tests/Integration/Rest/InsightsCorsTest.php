...
/**
 * P6.3 — CORS regression for the new insights fleet route:
 *   - GET /defyn/v1/insights
 *
 ...
 * @group integration
 */
final class InsightsCorsTest extends AbstractSchemaTestCase
{
    ...
    {
        return [
            'GET /insights' => ['GET', '/defyn/v1/insights'],
        ];
    }
}
