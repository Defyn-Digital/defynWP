...
/**
 * P4.3b — CORS regression for the new dismiss-toggle route:
 *   - POST /defyn/v1/sites/{id}/vulnerabilities/dismiss
 *
 ...
 * @group integration
 */
final class SitesVulnerabilitiesDismissCorsTest extends AbstractSchemaTestCase
{
    ...
    {
        return [
            'POST /sites/1/vulnerabilities/dismiss' => ['POST', '/defyn/v1/sites/1/vulnerabilities/dismiss'],
        ];
    }
}
