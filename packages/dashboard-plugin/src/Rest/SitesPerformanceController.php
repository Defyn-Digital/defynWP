...
/**
 * P6.1 — GET /defyn/v1/sites/{id}/performance
 * Returns the latest stored PageSpeed snapshot for the given site (or null when
 * none has been measured yet). Ownership-gated: 404 sites.not_found when the
 * site is not owned by the caller.
 * Envelope: { data: { latest: {…}|null }, error: null }.
 */
