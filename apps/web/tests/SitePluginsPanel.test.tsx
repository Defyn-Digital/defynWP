...
describe('SitePluginsPanel', () => {
  ...
  it('renders plugin rows from the API', async () => {
    mockSitePlugins[42] = {
      plugins: [
        { slug: 'akismet/akismet.php', name: 'Akismet', version: '5.3.1', update_available: true, update_version: '5.3.5', update_state: 'idle', last_update_error: null, last_update_attempt_at: null },
        { slug: 'rank-math/rank-math.php', name: 'Rank Math', version: '1.0.234', update_available: false, update_version: null, update_state: 'idle', last_update_error: null, last_update_attempt_at: null },
      ],
  ...
  it('filters to updates-only when toggle is on', async () => {
    mockSitePlugins[42] = {
      plugins: [
        { slug: 'a.php', name: 'A', version: '1.0', update_available: false, update_version: null, update_state: 'idle', last_update_error: null, last_update_attempt_at: null },
        { slug: 'b.php', name: 'B', version: '2.0', update_available: true, update_version: '2.1', update_state: 'idle', last_update_error: null, last_update_attempt_at: null },
      ],
      last_synced_at: '2026-06-04 11:30:00',
    };
