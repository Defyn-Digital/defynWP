...
describe('SiteDetail', () => {
  ...
  it('shows pending state and a connecting message', async () => {
    mockSites.push({
      ...
      ssl_status: null, ssl_expires_at: null, core_update_available: false, core_update_version: null, core_update_state: 'idle', last_core_update_error: null, last_core_update_attempt_at: null, core_allow_major: false, alerts_muted: false, auto_send_reports: false,
    });
    renderAt(1);
  ...
  it('shows active state with last_contact_at', async () => {
    mockSites.push({
      ...
      ssl_status: 'enabled', ssl_expires_at: '2027-01-01T00:00:00Z', core_update_available: false, core_update_version: null, core_update_state: 'idle', last_core_update_error: null, last_core_update_attempt_at: null, core_allow_major: false, alerts_muted: false, auto_send_reports: false,
    });
    renderAt(1);
...
describe('SiteDetail runtime info', () => {
  ...
  it('shows runtime info when site is active and synced', async () => {
    mockSites.push({
      ...
      theme_counts: { installed: 2, active: 1 },
      ssl_status: 'enabled',
      ssl_expires_at: '2027-01-01T00:00:00Z', core_update_available: false, core_update_version: null, core_update_state: 'idle', last_core_update_error: null, last_core_update_attempt_at: null, core_allow_major: false, alerts_muted: false, auto_send_reports: false,
    });
    mockSiteThemes[1] = [
      {
  ...
  it('shows "not yet synced" placeholder when wp_version is null', async () => {
    mockSites.push({
      ...
      theme_counts: null,
      ssl_status: null,
      ssl_expires_at: null, core_update_available: false, core_update_version: null, core_update_state: 'idle', last_core_update_error: null, last_core_update_attempt_at: null, core_allow_major: false, alerts_muted: false, auto_send_reports: false,
    });
